...
const TEMPLATES = [
  ...
  },
  {
    ...
    icon: BarChart3,
    title: "Dashboard",
    description: "A data dashboard or tracker",
    example: "Floor price, volume, charts, recent sales, live data",
  ...
  },
  {
    ...
    icon: Search,
    title: "Lookup Tool",
    description: "Search by wallet, token ID, or traits",
    example: "Paste a wallet or token ID, see badges, rarity, holdings, sales",
    color: "text-cyan-400",
  ...
  },
  {
    ...
    example: "Top holders, sweepers, badge counts, activity rankings",
  ...
  },
  {
    ...
    example: "Game board, scoring, lives, game over screen",
  ...
  },
  {
    ...
    example: "1v1 matchups, polls, community voting, results",
  ...
  },
  {
    ...
    example: "Connect wallet, show your GVCs, badges, collection stats",
